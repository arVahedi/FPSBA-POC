 ...
 * will be handled in the logical deletion way automatically, thanks to {@link com.db.product.database.listener.EnhancedDeleteEventListener}.
 *
 * @param <I> the type of identity of entity which should be a subclass of {@link Number}
 * @see com.db.product.database.listener.EnhancedDeleteEventListener
 */
