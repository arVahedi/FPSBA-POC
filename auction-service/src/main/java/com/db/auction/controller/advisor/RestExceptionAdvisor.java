package com.db.auction.controller.advisor;


import com.db.auction.assets.ErrorCode;
...
public class RestExceptionAdvisor extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ResponseTemplate<String>> handleUniqueConstraintAlreadyExistsException(UniqueConstraintAlreadyExistsException ex) {
        log.error(ex.getMessage(), ex);
        ResponseTemplate<String> responseTemplate = new ResponseTemplate<>(HttpStatus.BAD_REQUEST, ex.getMessage());
        return new ResponseEntity<>(responseTemplate, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(BidMinimumPriceViolationException.class)
    public ResponseEntity<ResponseTemplate<String>> handleBidMinimumPriceViolationException(BidMinimumPriceViolationException ex) {
        log.error(ex.getMessage(), ex);
        ResponseTemplate<String> responseTemplate = new ResponseTemplate<>(HttpStatus.BAD_REQUEST, ex.getMessage());
        return new ResponseEntity<>(responseTemplate, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ResponseTemplate<String>> handleObjectMappingException(ObjectMappingException ex) {
        log.error(ex.getMessage(), ex);
        ResponseTemplate<String> responseTemplate = new ResponseTemplate<>(HttpStatus.BAD_REQUEST, ex.getMessage());
        return new ResponseEntity<>(responseTemplate, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ResponseTemplate<String>> handleAuctionNotExistException(AuctionNotExistException ex) {
        log.error(ex.getMessage(), ex);
        ResponseTemplate<String> responseTemplate = new ResponseTemplate<>(HttpStatus.BAD_REQUEST, ex.getMessage());
        return new ResponseEntity<>(responseTemplate, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ResponseTemplate<String>> handleAuctionInactiveException(AuctionInactiveException ex) {
        log.error(ex.getMessage(), ex);
        ResponseTemplate<String> responseTemplate = new ResponseTemplate<>(HttpStatus.BAD_REQUEST, ex.getMessage());
        return new ResponseEntity<>(responseTemplate, HttpStatus.BAD_REQUEST);
    }
