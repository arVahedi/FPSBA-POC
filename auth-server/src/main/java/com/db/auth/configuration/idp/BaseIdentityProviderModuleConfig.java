...
import com.db.auth.configuration.BaseConfig;
 ...
 *
 * @see com.db.auth.configuration.WebSecurityConfig
 */
@Order(99)
public abstract class BaseIdentityProviderModuleConfig implements BaseConfig {
     ...
     * by {@link com.db.auth.configuration.WebSecurityConfig#authenticationManager(AuthenticationConfiguration) this method}
     ...
     * To fix this issue we have to disable the logout feature of HttpSecurity and then configure the logout logic manually. (For further information take a look at {@link com.db.auth.configuration.WebSecurityConfig#createLogoutFilter(HttpSecurity)}
