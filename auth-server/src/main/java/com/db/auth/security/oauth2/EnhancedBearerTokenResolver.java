...
import static com.db.auth.assets.Constant.AUTHORIZATION_TOKEN_COOKIE_NAME;
import static com.db.auth.assets.Constant.AUTHORIZATION_TOKEN_PREFIX;


/**
 * This class is a Decorator of Spring {@link DefaultBearerTokenResolver}
