...
import com.db.auth.utility.identity.JwtUtility;
...
/**
 * This service class is used for authenticating users via their username and password. It's usually used by {@link com.db.auth.controller.AuthenticationController}
